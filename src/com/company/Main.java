...
public class Main {
    ...
    public static void printTuesdays(List<Entry> entries) {
       ...
       for(Entry entry : entries){
        ...
        // write stream
        entries.stream().filter(d -> d.getDay() == Day.TUESDAY);
    ...
    public static void countTueWedThur(List<Entry> entries) {
        ...
        long count1 = 0;
        // write stream
        entries.stream().filter(d -> d.getDay() == Day.TUESDAY || d.getDay() == Day.WEDNESDAY || d.getDay() == Day.THURSDAY).count();
    ...
    public static void weekendList(List<Entry> entries) {
        ...
        weekends = entries.stream().filter(d -> d.getDay() == Day.SATURDAY || d.getDay() == Day.SUNDAY).collect(Collectors.toList());
                System.out.println(weekends);
        System.out.println();
    }
    ...
    public static void weekdaySet(List<Entry> entries) {
        ...
        weekdays = entries.stream().filter(d -> d.getDay() != Day.SATURDAY || d.getDay() != Day.SUNDAY).map(entry -> entry.toString()).collect(Collectors.toSet());
                System.out.println(weekdays);
        System.out.println();
    }
